...
export function AdvancedAvatarUpload({
  ...
  // Called when the crop area is changed, stores the cropped area pixels for later use
  ...
  // Processes selected image file by compressing and preparing for cropping
  ...
  // Handles file input change event and triggers image processing
  ...
  // Handles drag leave event to remove drop zone highlight
  const handleDragLeave = (e: React.DragEvent<HTMLDivElement>) => {
    e.preventDefault();
    setIsDragging(false);
  };

  // Handles file drop event and triggers image processing for dropped files
  ...
  // Saves the cropped avatar image and converts it to a file
  ...
  // Cancels the cropping operation and resets to previous state
  ...
  // Cancels the current file selection and reverts to the previous avatar
  ...
  // Permanently removes the avatar by clearing preview and calling the remove callback
  ...
  // Captures a photo from the webcam and prepares it for cropping
  ...
  // Handles webcam errors and displays user-friendly error messages

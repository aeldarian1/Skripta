...
export function AvatarUpload({ currentAvatarUrl, onFileSelect, onRemoveAvatar, username }: AvatarUploadProps) {
  ...
  // Handles file input change, validates file, creates preview, and triggers selection callback
  ...
  // Cancels the current avatar selection and reverts to the previous avatar
  ...
  // Permanently removes the avatar and clears the file input

...
export function AdvancedBannerUpload({
  ...
  // Validates file type, size (max 15MB), and format for banner uploads
  ...
  // Processes selected banner file by compressing and preparing for cropping
  ...
  // Handles file input change event and triggers banner image processing
  ...
  // Handles file drop event and triggers banner image processing for dropped files
  ...
  // Saves the cropped banner image and converts it to a file
  ...
  // Cancels the current file selection and reverts to the previous banner
  ...
  // Permanently removes the banner by clearing preview and calling the remove callback
